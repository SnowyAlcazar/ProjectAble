...
<img style="border:1px solid gray;" src="img/5a. Current Status Report 1.png" height="300px" width="150px">  <img style="border:1px solid gray;" src="img/5b. Current Status Report 2.png" height="300px" width="150px">  <img style="border:1px solid gray;" src="img/Project Info MPB Updated BAC.png" height="300px" width="150px">  <img style="border:1px solid gray;" src="img/9. Manual Budgets List.png" height="300px" width="150px">  <img style="border:1px solid gray;" src="img/10. Edit Manual Budget.png" height="300px" width="150px">   <img style="border:1px solid gray;" src="img/Project List Filter Menu on way to setting Complete.png" height="300px" width="150px">   <img style="border:1px solid gray;" src="img/Project List Active Filter.png" height="300px" width="150px">   
